...
Since we are asked to compare between the 2 groups, I applied facet_wrap to better visualize it. The control arm have overall lower values throughout the 8 weeks as compared to the experimental arm which has an overall increasing trend. The control arm has much more variability and fluctuations throughout the 8 weeks with no apparent trend.
